...
(function() {
  var ObjectID, async, connect, fs, importFixtures, insertItems, loadFixtures, mkdirp, outcome, path, readline, removeExplicit, removeReferences, stepc, traverse, validate, _types;
